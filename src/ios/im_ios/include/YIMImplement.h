...
class YIMImplement : IYIMLoginCallback,IYIMChatRoomCallback,IYIMMessageCallback,IYIMDownloadCallback,IYIMContactCallback ,IYIMAudioPlayCallback, IYIMLocationCallback, IYIMNoticeCallback, IYIMReconnectCallback, IYIMUserProfileCallback, IYIMFriendCallback
{
public:
...
public:
    ...
    //语音识别的文字
    virtual void OnGetRecognizeSpeechText(XUINT64 requestID, YIMErrorcode errorcode,const XString& text) override;
    ...
    //获取房间成员数量回调
    virtual void OnGetRoomMemberCount(YIMErrorcode errorcode, const XString& chatRoomID, unsigned int count) override;
     ...
     */
    virtual void OnBeRequestAddFriendNotify(const XString& userID, const XString& comments, XUINT64 reqID) override;
